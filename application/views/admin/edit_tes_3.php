<div class="container-fluid">
    <div class="card w-75 m-auto">
        <div class="card-header mb-3">
            <h1>
                <center>EDIT TES 3</center>
            </h1>
        </div>
        <div class="card-body">
            <?php
            echo form_open('soal/edit_soal_3');
            ...
            <div class="row d-flex justify-content-center p-1">
                <table class="text-center d-flex justify-content-center p-1">
                    ...
                    <tr class="row">
                        <td class="col-sm-4"><input value="<?php echo $soal->option_1; ?>" oninput="edit_tes_3()" type="text" name="option_1" id="input1" maxlength="2" class="form-control" style="text-align:center;"></td>
                        <td class="col-sm-4"><input value="<?php echo $soal->option_2; ?>" oninput="edit_tes_3()" type="text" name="option_2" id="input2" maxlength="2" class="form-control" style="text-align:center;"></td>
                        <td class="col-sm-4"><input value="<?php echo $soal->option_3; ?>" oninput="edit_tes_3()" type="text" name="option_3" id="input3" maxlength="2" class="form-control" style="text-align:center;"></td>
                    </tr>
                </table>
            </div>
            <hr>
            ...
            <div class="row d-flex justify-content-center btn-group" data-toggle="buttons">
                ...
                <div class="btn-group" data-toggle="buttons">
                    ...
                    <label class="btn btn-primary btn-hover">
                        <input value="<?php echo $soal->option_2; ?>" type="radio" name="Jawaban" id="value_radio_tes_2_2" autocomplete="off" style="display:none;">
                        <h5 id="label_radio_tes_2_2" class="d-flex justify-content-center"><?php echo $soal->option_2; ?></h5>
                    </label>
                    <label class="btn btn-primary btn-hover">
                        <input value="<?php echo $soal->option_3; ?>" type="radio" name="Jawaban" id="value_radio_tes_2_3" autocomplete="off" style="display:none;">
                        <h5 id="label_radio_tes_2_3" class="d-flex justify-content-center"><?php echo $soal->option_3; ?></h5>
                    </label>
                </div>
